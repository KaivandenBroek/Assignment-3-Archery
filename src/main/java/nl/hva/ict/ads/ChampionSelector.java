...
public class ChampionSelector {
    ...
    /**
     * Enrolls all nrOfArchers into the champion selector of the competition Every
     * archer is registered by id, first name and last name. Every archer shoots all
     * of its rounds and registers its scores
     * 
     * @param nrOfArchers the number of archers in the list.
     * @return the complete list of all archers that have been registered in this
     *         competition
     */
    ...
    /**
     * Simulates the archer shooting all rounds and register the scores confirmed by
     * the judges
     * 
     * @param archer
     */
